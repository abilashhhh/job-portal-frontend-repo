          ...
          <div className="absolute -bottom-16 left-8">
            <div className="relative group">
              <div className="w-32 h-32 rounded-full border-4 border-background overflow-hidden shadow-xl bg-background">
                <img
                  src={user?.profile_pic ? user?.profile_pic : "/userimg.jpg"}
                  alt=""
        ...
        <div className="pt-20 pb-8 px-8">
          ...
          <div className="mt-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-lg border hover:border-blue-900 transition-colors">
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center gap-3 p-4 rounded-lg border hover:border-blue-500 transition-colors">
                ...
                <div className="flex-1">
                  <p className="font-medium text-sm">Resume Document</p>
                  <Link
                    href={user.resume}
