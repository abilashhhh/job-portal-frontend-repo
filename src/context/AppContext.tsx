...
export const AppProvider: React.FC<AppProviderProps> = ({ children }) => {
  ...
  async function updateResume(formData: any) {
    ...
    try {
      const { data } = await axios.put(
        `${User_Service}/api/users/updateResume`,
        formData,
        { headers: { Authorization: `Bearer ${token}` } },
      );
  ...
  async function updateUser(name: string, phone_number: number, bio: string) {
    try {
      setBtnLoading(true);
      const { data } = await axios.put(
        `${User_Service}/api/users/updateProfile`,
  ...
  async function addSkill(
    ...
    try {
      const { data } = await axios.post(
        `${User_Service}/api/users/skill/add`,
        { skillName: skill },
        { headers: { Authorization: `Bearer ${token}` } },
      );
      toast.success(data.message);
  ...
  async function deleteSkill(skill: string) {
    try {
      const { data } = await axios.put(
        `${User_Service}/api/users/skill/delete`,
        { skillName: skill },
        { headers: { Authorization: `Bearer ${token}` } },
      );
      toast.success(data.message);
